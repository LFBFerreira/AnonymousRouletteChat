	...
	Chat.renderMessages
		...
		content: (msg, num) !->
			...
			Dom.div !->
				...
				anon_msg_client = if (luckyNumber == 0) then false else true

				if not anon_msg_client
				...
				Dom.div !->
					...
					Dom.div !->
						...
						name_display = if anon_msg_client then name else "Coward"

						Dom.text name_display
						Dom.text "(" + luckyNumber + ")"
						Dom.text " • "
